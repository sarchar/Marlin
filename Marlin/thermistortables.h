...
#if (THERMISTORHEATER_0 == 14) || (THERMISTORHEATER_1 == 14) || (THERMISTORHEATER_2 == 14) || (THERMISTORBED == 14) // MakerFarm thermistor
const short temptable_14[][2] PROGMEM = {
   ...
   {84*OVERSAMPLENR, 220},
   {91*OVERSAMPLENR, 215},
   {100*OVERSAMPLENR, 210},
   {109*OVERSAMPLENR, 205},
   {119*OVERSAMPLENR, 200},
   {130*OVERSAMPLENR, 192},
   {142*OVERSAMPLENR, 188},
   {155*OVERSAMPLENR, 185},
   {170*OVERSAMPLENR, 180},
   {186*OVERSAMPLENR, 175},
   {204*OVERSAMPLENR, 168},
